  ...
  if (newSection !== currentSection) {
    ...
    switch (newSection) {
      case "Home":
        animateText(
          text_box,
          "Hi, my name is Marius and I'm a creator with lots of ideas...<br><br>Use arrow keys or WASD to navigate<br><br><a href='https://github.com/mariusschueller'>GitHub</a> <a href='https://www.linkedin.com/in/mariusschueller/'>LinkedIn</a> <a href='mailto:marius@mariusschueller.com'>Mail</a>"
        );
        section_views();
        break;
      case "Projects":
        ...
        all_project_view.style.animation =
          "appear 1s, pulse-glow 2s ease-in-out infinite 1s";
        coding_project_view.style.display = "flex";
        coding_project_view.style.animation =
          "appear 1s, pulse-glow 2s ease-in-out infinite 1s";
        music_project_view.style.display = "flex";
        music_project_view.style.animation =
          "appear 1s, pulse-glow 2s ease-in-out infinite 1s";
        design_project_view.style.display = "flex";
        design_project_view.style.animation =
          "appear 1s, pulse-glow 2s ease-in-out infinite 1s";
        threeD_project_view.style.display = "flex";
        threeD_project_view.style.animation =
          "appear 1s, pulse-glow 2s ease-in-out infinite 1s";
        break;
      case "Blog":
      ...
      case "About":
        ...
        professional_about_view.style.animation =
          "appear 1s, pulse-glow 2s ease-in-out infinite 1s";
        coding_about_view.style.display = "flex";
        coding_about_view.style.animation =
          "appear 1s, pulse-glow 2s ease-in-out infinite 1s";
        music_about_view.style.display = "flex";
        music_about_view.style.animation =
          "appear 1s, pulse-glow 2s ease-in-out infinite 1s";
        teaching_about_view.style.display = "flex";
        teaching_about_view.style.animation =
          "appear 1s, pulse-glow 2s ease-in-out infinite 1s";
        hobbies_about_view.style.display = "flex";
        hobbies_about_view.style.animation =
          "appear 1s, pulse-glow 2s ease-in-out infinite 1s";
        break;
      case "Contact":
        animateText(
          text_box,
          'Talk to me at <a href="mailto:marius@mariusschueller.com">marius@mariusschueller.com</a>'
        );
        section_views();
        break;
    }
